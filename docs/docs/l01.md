...
- DM Web Application: `https://aws.dm.paper` or `https://az.dm.paper` (instead of `aws|az.unique-id.sec540.cloud`)
- DM API Gateway: `https://gateway-aws.dm.paper` or `https://gateway-az.dm.paper` (instead of `gateway-aws|az.unique-id.sec540.cloud`)
